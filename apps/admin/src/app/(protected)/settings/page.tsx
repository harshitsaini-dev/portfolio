        ...
        initialValues={
          settings
            ? {
                ...
                offlineAccent: settings.screenAccents.offline ?? "",
                notFoundAccent: settings.screenAccents.notFound ?? "",
                errorAccent: settings.screenAccents.error ?? "",
                deniedAccent: settings.screenAccents.denied ?? "",
