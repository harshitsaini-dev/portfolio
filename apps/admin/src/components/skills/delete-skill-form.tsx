...
/**
 * Delete confirmation for a skill.
 *
 ...
 * is suppressible.
 *
 * Nothing references `skills`, so this removes one row and cascades to
 * nothing; the owning category is untouched.
 *
