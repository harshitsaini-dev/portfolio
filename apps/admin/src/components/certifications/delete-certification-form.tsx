...
/**
 * Delete confirmation for a certification.
 *
...
export function DeleteCertificationForm({
  certificationId,
  certificationLabel,
}: {
    ...
    return (
      <div className="mt-5">
        ...
        >
          ...
          <span className="sr-only"> {certificationLabel}</span>
        </button>
        {errorMessage ? (
  ...
  return (
    <form action={formAction} className="mt-5">
      ...
      <p role="alert" className="text-sm font-medium text-fg">
        Delete “{certificationLabel}” permanently?
      </p>
