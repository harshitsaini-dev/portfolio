 ...
 *
 * Nothing references `robot_lines`, so this removes one row and cascades to
 * nothing.
 *
...
import { deleteRobotLineAction } from "@/lib/actions/robot-lines";

export function DeleteRobotLineForm({
  lineId,
  lineText,
}: {
  lineId: string;
